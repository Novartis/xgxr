...
This document contains exploratory plots for single ascending dose PK and PD data as well as the R code that generates these graphs. The plots presented here are based on simulated data ([see: ...)). You may also download the the dataset for your reference ([download dataset](data/Case1_PKPDdataset.csv)).
