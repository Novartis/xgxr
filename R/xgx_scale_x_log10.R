...
#' 
#' \code{xgx_scale_x_log10} is similar to \code{\link[ggplot2:scale_continuous]{scale_x_log10}}.  
#' But it uses what we believe to be a nicer spacing and set of tick marks
#' it can be used the same as \code{\link[ggplot2:scale_continuous]{scale_x_log10}}
#'
...
#' @param ... other arguments passed to \code{\link[ggplot2:scale_continuous]{scale_x_log10}}
#'
